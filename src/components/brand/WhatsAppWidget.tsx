  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
        ...
        <div className="mb-3 w-[320px] overflow-hidden rounded-3xl border border-borderLight bg-white shadow-soft-dark" role="dialog" aria-label="Chat de WhatsApp">
          ...
          <div className="space-y-4 bg-[#0b1d13] p-4 text-white">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-base font-bold text-white transition hover:bg-[#1daa56]"
            >
      ...
      <button
        ...
        className="ml-auto inline-flex h-16 w-16 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_12px_24px_rgba(37,211,102,0.45)] transition hover:scale-105"
